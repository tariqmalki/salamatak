...
// Safety Map - visual map-like display of restaurants color-coded by safety level
// This is a UI-only static map (no real map API used)
export default function SafetyMap() {
  // Group restaurants by safety level
  const grouped = {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <p className="text-gray-500 mb-6">See which restaurants are safe for allergy sufferers</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 relative z-10">
          {restaurants.map((r) => {
            ...
            return (
              <div
                key={r.id}
                className={`rounded-2xl p-4 border-2 transition-colors ${colors[r.safetyLevel]}`}
              >
      ...
      {/* Detailed lists by safety level */}
